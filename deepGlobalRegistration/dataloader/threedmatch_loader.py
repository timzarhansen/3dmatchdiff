...
from deepGlobalRegistration.util.pointcloud import get_matching_indices, make_open3d_point_cloud
from deepGlobalRegistration.util.file import read_trajectory
...
class IndoorPairDataset(PairDataset):
  ...
  def __getitem__(self, idx):
    ...
    pcd0 = make_open3d_point_cloud(xyz0_th[sel0])
    pcd1 = make_open3d_point_cloud(xyz1_th[sel1])
