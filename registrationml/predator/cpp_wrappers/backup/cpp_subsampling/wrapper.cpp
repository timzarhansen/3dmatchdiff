#define NPY_NO_DEPRECATED_API NPY_1_7_API_VERSION  // Add this at the top
#include <Python.h>
...
//    static const char* kwlist[] = { "points", "batches", "features", "classes", "sampleDl", "method", "max_p", "verbose", NULL };
	float sampleDl = 0.1;
	...
	PyArrayObject* points_arr = (PyArrayObject*)points_array;
    if ((int)PyArray_NDIM((PyArrayObject*)points_arr) != 2 || (int)PyArray_DIM((PyArrayObject*)points_arr, 1) != 3)
	{
		Py_XDECREF(points_array);
		Py_XDECREF(batches_array);
		Py_XDECREF(classes_array);
	...
	// Number of points
//	PyArrayObject* points_arr = (PyArrayObject*)points_array;
    int N = (int)PyArray_DIM((PyArrayObject*)points_arr, 0);
...
//	PyArrayObject* points_arr = (PyArrayObject*)points_array;
    original_points = vector<PointXYZ>(
        (PointXYZ*)PyArray_DATA((PyArrayObject*)points_arr),
        (PointXYZ*)PyArray_DATA((PyArrayObject*)points_arr) + N
    );
