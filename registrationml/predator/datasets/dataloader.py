...
import torch
import registrationml.predator.cpp_wrappers.cpp_subsampling.grid_subsampling as cpp_subsampling
import registrationml.predator.cpp_wrappers.cpp_neighbors.radius_neighbors as cpp_neighbors
# import registrationml.predator.cpp_wrappers.cpp_neighbors.neighbors as cpp_neighbors
from registrationml.predator.lib.timer import Timer
from registrationml.predator.lib.utils import load_obj, natural_key
from registrationml.predator.datasets.indoor import IndoorDataset
from registrationml.predator.datasets.kitti import KITTIDataset
from registrationml.predator.datasets.modelnet import get_train_datasets, get_test_datasets
...
def batch_neighbors_kpconv(queries, supports, q_batches, s_batches, radius, max_neighbors):
    ...
    # neighbors = cpp_neighbors.batch_query_docstring(queries, supports, q_batches, s_batches, radius=radius)
