...
from deepGlobalRegistration.configs.config import get_config

from deepGlobalRegistration.dataloader.data_loaders import make_data_loader

from deepGlobalRegistration.core.trainer import WeightedProcrustesTrainer
